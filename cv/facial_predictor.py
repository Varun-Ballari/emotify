...
class FacialRecognizer(object):
    ...
    def setup(self):
        ...
        # faces, labels = self.prepare_training_data(os.path.join(dir, "training_data"))
        # print("Data prepared")
        ...
        #
        # face_recognizer.save(model_dir + "face_recognizer_varns.xml")

        face_recognizer.read(model_dir + "face_recognizer_varns.xml")
